...
echo.
echo ============================================================================
echo Sit your ass down activating your Office...
...
cscript //nologo ospp.vbs /act | find /i "successful" 
 ...
 (echo.
echo ============================================================================
echo #Please feel free to contact me at 1downy11@gmail.com if you have any questions or concerns.
echo ============================================================================
choice /n /c YN /m "Would you consider giving a star to the GitHub repository? Your support would be greatly appreciated. [Y,N]" 
 ...
 set /a i+=1 
 goto server)
explorer "https://github.com/1downy"
goto halt
:notsupported
echo.
echo ============================================================================
